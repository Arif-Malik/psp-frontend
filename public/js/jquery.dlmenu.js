(function ($, window, undefined) {
    ...
    $.DLMenu.prototype = {
        ...
        _config: function () {
            ...
            this.$el.find('ul.dl-submenu').prepend('<li class="dl-back"><a href="#"><span>back</span></a></li>');
        ...
        _initEvents: function () {
                    ...
                    var $flyin = $submenu.clone().css('opacity', 0).insertAfter(self.$menu),
                        onAnimationEndFn = function () {
                            ...
                            var hideTop = $(".dl-bottom-menu").find(".dl-subviewopen"),
                                hideBorder = $(".dl-top-menu").find(".dl-subviewopen");
                            if (hideTop.length > 0) {
                                $('.dl-top-menu').css("display", "none");
                            }
                            if (hideBorder.length > 0) {
                                $('.dl-top-menu').css("border-bottom", "none");
                            }
                        };
            ...
            this.$back.on('click.dlmenu', function (event) {
                ...
                setTimeout(function () {
                    ...
                    var hideTop = $(".dl-bottom-menu").find(".dl-subviewopen"),
                        showBorder = $(".dl-top-menu").find(".dl-subviewopen");

                    if (hideTop.length === 0) {
                        $('.dl-top-menu').css("display", "block");
                    }
                    if (showBorder.length === 0) {
                        $('.dl-top-menu').css("border-bottom", "2px solid #393636");
                    }
                });
